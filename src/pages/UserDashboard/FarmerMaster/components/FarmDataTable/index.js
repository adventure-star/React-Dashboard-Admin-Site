...
import { apiUserFarmerMasterFarmDataById } from 'services/apis/user_users';
...
function FarmDataTable(props) {
  ...
  const getData = () => {
    ...
    apiUserFarmerMasterFarmDataById(props.id, { per_page, page_no, order_by, order_type, ...keywords })
      .then(res => {
        console.log('===== farmerdata: ', res);
        if (res) {
          setMembers(res);
        }
      })
